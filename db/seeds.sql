...
-- Insert 6 burger choices from Big Fernand in the Burgers table: 1) burger_name, 2) devoured (boolean - default false, only included if true)
...
INSERT INTO burgers (burger_name, devoured) VALUES ('LE LUCIEN (VÉGÉTARIEN)', true);
